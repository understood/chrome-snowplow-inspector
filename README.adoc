...
NOTE: This is Understood.org's fork, which adds inline Contentful ID resolution to the event detail view.
See link:README.understood.adoc[README.understood.adoc] for setup, configuration, and the upstream sync procedure.
